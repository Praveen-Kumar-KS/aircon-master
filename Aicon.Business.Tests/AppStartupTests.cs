...
namespace Aicon.Business.UnitTests
{
    ...
    public class AppStartupTests
    {
        ...
        public void Startup_WhenBuildServiceCollection_ShouldDependenciesBeRegistered()
        {
            ...
            IHostEnvironment env = new HostingEnvironment { EnvironmentName = Environments.Development, ContentRootPath = "C:\\Aircon\\Aircon" };
            WebHost
                ...
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    ...
                    startup = new Startup(env, config.Build());
                })
