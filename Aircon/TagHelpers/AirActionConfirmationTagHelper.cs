...
namespace Aircon.TagHelpers
{
    ...
    /// </summary>
    [HtmlTargetElement("air-action-confirmation", Attributes = BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class AirActionConfirmationTagHelper : TagHelper
    {
        #region Constants
        ...
        public AirActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var partialView = await _htmlHelper.PartialAsync("ActionConfirm", actionConfirmationModel);
