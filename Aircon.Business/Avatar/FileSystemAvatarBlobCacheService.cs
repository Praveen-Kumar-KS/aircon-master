...
{
    public class FileSystemAvatarBlobCacheService : IAvatarBlobCacheService
    {
        private readonly PhysicalFileProvider _fileProvider;
        private readonly ILogger<FileSystemAvatarBlobCacheService> _log;

        public FileSystemAvatarBlobCacheService(IConfiguration configuration, ILogger<FileSystemAvatarBlobCacheService> log)
        {
